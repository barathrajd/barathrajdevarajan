...
import { FaBolt, FaDatabase, FaLayerGroup, FaCube } from 'react-icons/fa';
...
export const TechStackCarousel = () => {
  const techStack = [
    ...
    { name: 'Rust', Icon: SiRust, color: '#CE422B', url: 'https://www.rust-lang.org' },
    ...
    { name: 'Material UI', Icon: SiMui, color: '#007FFF', url: 'https://mui.com' },
    { name: 'Shadcn/UI', Icon: SiShadcnui, color: '#000000', url: 'https://ui.shadcn.com' },
    { name: 'Core UI', Icon: FaLayerGroup, color: '#000000', url: 'https://coreui.io' },
    
    // State Management
    { name: 'Redux', Icon: SiRedux, color: '#764ABC', url: 'https://redux.js.org' },
    { name: 'Zustand', Icon: FaDatabase, color: '#443E38', url: 'https://zustand-demo.pmnd.rs' },
    ...
    { name: 'Rspack', Asset: rspackLogo, color: '#F6C51D', url: 'https://rspack.dev' },
    { name: 'Rsbuild', Asset: rsbuildLogo, color: '#F6C51D', url: 'https://rsbuild.dev' },
    { name: 'Rslib', Asset: rslibLogo, color: '#F6C51D', url: 'https://github.com/web-infra-dev/rslib' },
    { name: 'Nx', Icon: SiNx, color: '#143055', url: 'https://nx.dev' },
    { name: 'Turborepo', Icon: SiTurborepo, color: '#EF4444', url: 'https://turbo.build' },
    { name: 'Rollup', Icon: FaCube, color: '#EC4A3F', url: 'https://rollupjs.org' },
    { name: 'tsup', Icon: FaBolt, color: '#FFCF00', url: 'https://tsup.egoist.dev' },
    
    // Testing & Quality
    { name: 'Jest', Icon: SiJest, color: '#C21325', url: 'https://jestjs.io' },
    { name: 'Vitest', Icon: SiVitest, color: '#6E9F18', url: 'https://vitest.dev' },
    { name: 'Biome', Icon: SiBiome, color: '#60A5FA', url: 'https://biomejs.dev' },
    { name: 'Prettier', Icon: SiPrettier, color: '#F7B93E', url: 'https://prettier.io' },
    { name: 'ESLint', Icon: SiEslint, color: '#4B32C3', url: 'https://eslint.org' },
    
    // General Tools
    { name: 'Git', Icon: SiGit, color: '#F05032', url: 'https://git-scm.com' },
    { name: 'NPM', Icon: SiNpm, color: '#CB3837', url: 'https://www.npmjs.com' },
