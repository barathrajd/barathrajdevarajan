  ...
  return (
    <section className="py-20 px-4">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="relative border-l-2 border-border pl-6 md:pl-8 ml-2 md:ml-4 space-y-12">
          {experience.map((exp) => (
            <div key={`${exp.company}-${exp.role}`} className="relative">
              {/* Timeline dot */}
              <div className="absolute -left-[35px] md:-left-[43px] top-6 h-5 w-5 rounded-full border-4 border-background bg-foreground/70" />
              ...
              <Card className="border-border bg-card">
                ...
                <CardContent>
                  {exp.description && exp.description.length > 0 && (
                    <ul className="mt-4 space-y-2 list-disc list-inside text-foreground/80 leading-relaxed marker:text-foreground/50">
